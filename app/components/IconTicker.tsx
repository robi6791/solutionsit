...
// Importujemy niezbędne ikonki, które mają być animowane
...
const stackIcons = [
  ...
  // === NOWE IKONY BAZ DANYCH I NARZĘDZI ===
  ...
  { icon: SiZod, color: "#3178C6", alt: "Zod Logo" }, // Kolor jak TS, bo często z nim powiązany
  { icon: SiShadcnui, color: "#FFFFFF", alt: "Shadcn/ui Logo" }, // Biały jako neutralny dla Shadcn
  // =========================================
];

// Duplikujemy listę trzykrotnie
const duplicatedIcons = [...stackIcons, ...stackIcons, ...stackIcons];

const IconTicker = () => {
  return (
    // ZWIĘKSZONO PADDING PIONOWY: py-8 -> py-16
    <div className="py-16 bg-black/70 backdrop-blur-md shadow-lg lg:shadow-xl shadow-blue-400 mt-10 lg:mt-16 mb-10 lg:mb-16">
      <div className="container mx-auto">
        {/* Maskowanie dla efektu nieskończonej pętli */}
        <div className="overflow-hidden [mask-image:linear-gradient(to_right,_transparent,_black_15%,_black_85%,_transparent)]">
          <motion.div
            // ZWIĘKSZONO ODSTĘP MIĘDZY IKONAMI: gap-20 -> gap-32
          ...
          >
            {duplicatedIcons.map((item, index) => {
              ...
              return (
                ...
                >
                  <IconComponent
                    // ZWIĘKSZONO ROZMIAR IKON: w-12 h-12 -> w-16 h-16
                    className="w-16 h-16 opacity-80 transition-opacity duration-300"
                    style={{
                      color: item.color,
